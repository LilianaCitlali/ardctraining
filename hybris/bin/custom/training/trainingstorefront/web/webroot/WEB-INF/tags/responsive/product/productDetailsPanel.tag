...
<%@ attribute name="productCustomLabels" required="true" type="java.util.List" %>
		...
		<div class="product-main-info">
			<div class="row">
				<div class="col-lg-6">
                    ...
                    <div class="product-details">
                        <c:forEach items="${productCustomLabels}" var="customLabel">
                            <div class="description">Label: ${customLabel.label}</div>
                        </c:forEach>
                    </div>
                </div>
