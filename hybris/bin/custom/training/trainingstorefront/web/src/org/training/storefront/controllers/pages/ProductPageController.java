...
public class ProductPageController extends AbstractPageController
{
	...
	//COMLILI
	@Resource(name = "defaultTrainingCustomerFacade")
	private DefaultTrainingCustomerFacade defaultTrainingCustomerFacade;
			...
			throws CMSItemNotFoundException, UnsupportedEncodingException
	{
		...
		//COMLILI
		model.addAttribute("productCustomLabels",defaultTrainingCustomerFacade.findProductCustomLabelsByCurrentUser(encodedProductCode));
