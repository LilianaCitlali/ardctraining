...
//comlili import de.hybris.platform.acceleratorstorefrontcommons.forms.RegisterForm;
...
import org.training.facades.customer.impl.DefaultTrainingCustomerFacade;
import org.training.storefront.form.TrainingRegisterForm;
...
public abstract class TrainingAbstractLoginPageController extends AbstractRegisterPageController{
    ...
    private DefaultTrainingCustomerFacade trainingCustomerFacade;

    protected Validator getTrainingRegistrationValidator()
    {
        return trainingRegistrationValidator;
    }

    protected DefaultTrainingCustomerFacade getTrainingCustomerFacade()
    {
        return trainingCustomerFacade;
    }
    ...
    protected String processRegisterUserRequestTraining(final String referer, final TrainingRegisterForm form, final BindingResult bindingResult,
        ...
        try
        {
            ...
            getTrainingCustomerFacade().register(data);
